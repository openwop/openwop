...
> **Last reviewed:** 2026-05-15 (status hygiene pass). The generated protocol snapshot lives at `docs/PROTOCOL-STATUS.md`: 32 prose specs, 24 JSON Schemas, 19 OpenAPI operations, AsyncAPI 3.1, 107 conformance scenario files, 13 RFCs tracked, and 48 indexed registry packs. Postgres reference conformance evidence is 781/850 default-mode pass count (91.9% total; 96.4% applicable) with one documented webhook flake. RFC 0012 is Accepted; RFC 0013 remains Draft.
