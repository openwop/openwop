...
- 32 prose specs under `spec/v1/` (see `docs/PROTOCOL-STATUS.md`)
- 24 first-class JSON Schemas (compile clean under Ajv2020)
...
**Postgres host conformance pass rate: 781/850 (91.9%)** — 96.4% of applicable scenarios, measured against suite v1.1.0 with conditional profiles advertised. The single recorded failure (`webhook-signed-delivery`) is documented as a full-suite timing collision that passes in isolation. See `INTEROP-MATRIX.md` for the full evidence claim.
