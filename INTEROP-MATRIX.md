...
| **Postgres** (reference example, SKELETON) | Multi-process durability + the eventual `production`-profile claimant | `examples/hosts/postgres/` | (none — skeleton) | (none — skeleton) | Not claimed | `examples/hosts/postgres/README.md` |
