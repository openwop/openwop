...
## [2.40.1] — unreleased — the harness OIDC issuer is an instrument a host claims
...
- **Version moved ahead of publication.** `@openwop/openwop-conformance` and its exact-pinned peer `@openwop/spec-artifacts` move to `2.40.1` because `2.40.0` is published. Not tagged, not published.
