...
<!-- The entries below belong to the 2.37.1 cycle. Its heading is NOT written here on
     purpose: the cycle-opening PR (branch fix/0213-in-flight-partial-witness) creates
     `## [2.37.1] — unreleased` along with the version pins, and two PRs inventing the
     same heading in an append-only file is a guaranteed conflict. -->
