...
## [2.41.2] — unreleased — the 2.41.2 cycle is open
...
- **Version moved ahead of publication.** `@openwop/openwop-conformance` and its exact-pinned peer `@openwop/spec-artifacts` move to `2.41.2` because `2.41.1` is tagged. Not tagged, not published.
