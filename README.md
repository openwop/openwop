...
| [`artifact-type-packs.md`](./spec/v1/artifact-type-packs.md) | FINAL v1.1 | ~1,150 | RFC 0071 Phase 1 — `kind: "artifact-type"` packs: distributable typed artifact definitions (schema + rendering hint + lifecycle); `host.artifactTypes` store/render/export negotiation |
| [`chat-card-packs.md`](./spec/v1/chat-card-packs.md) | FINAL v1.1 | ~1,200 | RFC 0071 Phase 2 — `kind: "card"` packs: AI chat cards (prompt template + typed input subset) bound to a typed `outputArtifactType`; `host.chat.cardPacks` execution + untrusted-input trust boundary |
...
Current generated state: 52 prose specs (37 FINAL + 6 DRAFT) · 56 JSON Schemas · 48 OpenAPI operations · AsyncAPI 3.1 · 330 conformance scenario files · 3 reference SDKs. See [docs/PROTOCOL-STATUS.md](./docs/PROTOCOL-STATUS.md) for the machine-generated snapshot.
...
- **[`spec/v1/`](./spec/v1/)** — 52 prose specs (35 `FINAL v1`/`v1.1`, 5 `DRAFT v1.x` extensions). Start with `rest-endpoints.md` and `auth.md`.
