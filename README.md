...
Current generated state: 51 prose specs (37 FINAL + 6 DRAFT) · 55 JSON Schemas · 48 OpenAPI operations · AsyncAPI 3.1 · 323 conformance scenario files · 3 reference SDKs. See [docs/PROTOCOL-STATUS.md](./docs/PROTOCOL-STATUS.md) for the machine-generated snapshot.
...
- **[`spec/v1/`](./spec/v1/)** — 51 prose specs (35 `FINAL v1`/`v1.1`, 5 `DRAFT v1.x` extensions). Start with `rest-endpoints.md` and `auth.md`.
