...
Current generated state: 44 prose specs (37 FINAL + 7 DRAFT) Â· 46 JSON Schemas Â· 39 OpenAPI operations Â· AsyncAPI 3.1 Â· 293 conformance scenario files Â· 3 reference SDKs. See [docs/PROTOCOL-STATUS.md](./docs/PROTOCOL-STATUS.md) for the machine-generated snapshot.
...
- **[`spec/v1/`](./spec/v1/)** â 44 prose specs (35 `FINAL v1`/`v1.1`, 6 `DRAFT v1.x` extensions). Start with `rest-endpoints.md` and `auth.md`.
