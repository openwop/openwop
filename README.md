...
Examples run end-to-end in CI via [`examples.yml`](https://github.com/openwop/openwop-examples/blob/main/.github/workflows/examples.yml) (in openwop-examples) so they don't go stale.
...
| TS reference SDK | [`sdk/typescript/`](https://github.com/openwop/openwop-sdks/tree/main/sdk/typescript) | 1.0 | `tsc` |
| Python reference SDK | [`sdk/python/`](https://github.com/openwop/openwop-sdks/tree/main/sdk/python) | 1.0 | `python3 -m ast` + import |
| Go reference SDK | [`sdk/go/`](https://github.com/openwop/openwop-sdks/tree/main/sdk/go) | 1.0 | `go vet` |
...
The reference node-pack registry at [`packs.openwop.dev`](https://packs.openwop.dev) **is live** (Stage 1–4 deployed 2026-05-12, packCount 48 as of 2026-05-13 across `core.openwop.*` / `community.openwop-team.*` / `vendor.openwop.*` / `vendor.myndhyve.*` trust tiers). See [`docs/PACK-CATALOG.md`](./docs/PACK-CATALOG.md) for the categorized inventory and [`examples/market-intel-pipeline/`](https://github.com/openwop/openwop-examples/tree/main/examples/market-intel-pipeline) + [`examples/ads-publish-pipeline/`](https://github.com/openwop/openwop-examples/tree/main/examples/ads-publish-pipeline) for reference compositions. For the canonical multi-agent worked example (orchestrator + dispatch + AgentRef + reasoning events + HITL + memory + RFC 0012 compaction) see [`examples/multi-agent-research-assistant/`](https://github.com/openwop/openwop-examples/tree/main/examples/multi-agent-research-assistant); for the cross-host counterpart that drives an external A2A peer end-to-end see [`examples/multi-agent-cross-host/`](https://github.com/openwop/openwop-examples/tree/main/examples/multi-agent-cross-host).
...
Current generated state: 52 prose specs (37 FINAL + 6 DRAFT) · 56 JSON Schemas · 48 OpenAPI operations · AsyncAPI 3.1 · 324 conformance scenario files · 3 reference SDKs. See [docs/PROTOCOL-STATUS.md](./docs/PROTOCOL-STATUS.md) for the machine-generated snapshot.
...
- **[`sdk/typescript/`](https://github.com/openwop/openwop-sdks/tree/main/sdk/typescript)** — `@openwop/openwop` (npm).
- **[`sdk/python/`](https://github.com/openwop/openwop-sdks/tree/main/sdk/python)** — `openwop-client` (PyPI).
- **[`sdk/go/`](https://github.com/openwop/openwop-sdks/tree/main/sdk/go)** — `github.com/openwop/openwop/sdk/go`.
