...
- [`docs/PHASE-4-PROGRESS.md`](./docs/PHASE-4-PROGRESS.md) — accountability tracking for the 5 behavioral-harness work-items (multi-region simulator, cross-engine append ordering, sandbox execution, replay determinism Phase 4, secret-leakage telemetry).
