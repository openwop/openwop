...
The v1 description, [`spec/v1/capabilities.md`](https://github.com/openwop/openwop/blob/main/spec/v1/capabilities.md) (`a2uiSurface`), is useful for migration but is not a
