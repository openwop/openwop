...
The v1 description,
[`spec/v1/host-capabilities.md`](https://github.com/openwop/openwop/blob/main/spec/v1/host-capabilities.md#hostwebresearch)
(§host.webResearch), is useful for migration but is not a
