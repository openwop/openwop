...
> **Status: Stable · v1.1.** Distinguishes the protocol's normative core from host-specific extensions. Canonical reference for any spec document that mentions a vendor-prefixed namespace (for example `acme.*`).
