...
> **Status: Stable · v1.1.** Additive discovery annex for detecting changes to `/.well-known/openwop` and for scoped capability views. Does not change the required v1 capability payload.
