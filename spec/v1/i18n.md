...
Hosts that advertise `capabilities.i18n.supported: true` are expected to pass `conformance/src/scenarios/i18n-negotiation.test.ts` (capability-gated) when that scenario lands. The scenario verifies:
