...
- Every other property name remains closed. `additionalProperties: false` still applies, so a misspelled canonical field (`dispalyName`) is still rejected — the hatch admits *declared* extensions, not arbitrary keys.
