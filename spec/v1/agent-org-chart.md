...
| Gap                                                                          | Disposition                                                                                                                                                                                                                            |
| ---------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `GET /v1/agents/org-chart[/{departmentId}]` + org-chart-management endpoints | **Closed (2026-09-02 audit).** `GET /v1/agents/org-chart` and `GET /v1/agents/org-chart/{departmentId}` are in `api/openapi.yaml`; this row had said "deferred" after the endpoints landed. Management stays host-private at v1.x.                 |
