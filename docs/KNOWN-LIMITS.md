...
| 0040, 0041 (Multi-agent execution model `version: 3` + `version: 4`) | `Active` | RFC 0041 staged-refusal seam wired against the reference workflow-engine end-to-end; RFC 0040 cross-host causation + the RFC 0041 nondeterministic-tool fixture await a second host. Path-to-`Accepted` is a non-steward host advertising `multiAgent.executionModel.version: 4` end-to-end. |
