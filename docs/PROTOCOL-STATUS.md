...
| Conformance scenario files | 464 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.137.0 | `conformance/package.json` | minor on scenario add/remove |
