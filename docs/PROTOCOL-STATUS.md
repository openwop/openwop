...
| Conformance scenario files | 451 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.114.0 | `conformance/package.json` | minor on scenario add/remove |
