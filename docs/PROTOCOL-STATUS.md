...
| Conformance scenario files | 434 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.95.1 | `conformance/package.json` | minor on scenario add/remove |
