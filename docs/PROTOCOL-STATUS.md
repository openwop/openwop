...
| Conformance scenario files | 458 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.126.0 | `conformance/package.json` | minor on scenario add/remove |
