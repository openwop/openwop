...
| Conformance scenario files | 459 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.128.0 | `conformance/package.json` | minor on scenario add/remove |
