...
|---|---:|---:|---:|---:|---:|---|
| Postgres reference | 1968 | 14 | 92 | 0 | 2074 | 94.9% total; ~99.3% of non-skipped (measured 2026-05-30 against suite v1.10.0 via pglite + OPENWOP_WEBHOOK_ALLOW_PRIVATE=true). Failures: agent-memory (×5) + agent-packs (×3) + aiEnvelope.capBreached (×3) + discovery / orchestratorConservativePath / sql-transaction-atomicity (the last a @timing-sensitive flake under full-suite parallelism). |
| SQLite reference | 1966 | 4 | 104 | 0 | 2074 | 94.8% total; ~99.8% of non-skipped (measured 2026-05-30 against suite v1.10.0). Failures: aiEnvelope.capBreached (×3) + discovery (×1). |
