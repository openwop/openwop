...
| Conformance scenario files | 505 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 2.0.0-rc.45 | `conformance/package.json` | minor on scenario add/remove |
