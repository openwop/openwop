...
| Conformance scenario files | 460 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.133.0 | `conformance/package.json` | minor on scenario add/remove |
