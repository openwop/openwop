...
| Conformance scenario files | 370 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.37.0 | `conformance/package.json` | minor on scenario add/remove |
