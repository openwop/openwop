...
| Conformance scenario files | 427 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.87.0 | `conformance/package.json` | minor on scenario add/remove |
