...
| Conformance scenario files | 351 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.28.0 | `conformance/package.json` | minor on scenario add/remove |
