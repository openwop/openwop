...
| Conformance scenario files | 407 | `conformance/src/scenarios/*.test.ts` |
| RFCs tracked | 142 | `RFCS/[0-9][0-9][0-9][0-9]-*.md`, excluding template |
...
| Conformance suite `@openwop/openwop-conformance` | 1.66.0 | `conformance/package.json` | minor on scenario add/remove |
...
- 3 RFCs still `Draft` (RFC 0038, RFC 0136, RFC 0140) — advance with schema/conformance proof or defer.
