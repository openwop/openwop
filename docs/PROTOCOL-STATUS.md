...
| RFCs tracked | 80 | `RFCS/[0-9][0-9][0-9][0-9]-*.md`, excluding template |
...
- 8 RFCs still `Draft` (RFC 0038, RFC 0043, RFC 0050, RFC 0072, RFC 0073, RFC 0078, RFC 0079, RFC 0080) — advance with schema/conformance proof or defer.
