...
|---|---:|---|
| Spec prose documents | 42 | `spec/v1/*.md` |
| JSON Schemas | 43 | `schemas/*.schema.json` |
| OpenAPI operations | 39 | `api/openapi.yaml` |
| AsyncAPI version | 3.1.0 | `api/asyncapi.yaml` |
| Conformance scenario files | 284 | `conformance/src/scenarios/*.test.ts` |
| RFCs tracked | 72 | `RFCS/[0-9][0-9][0-9][0-9]-*.md`, excluding template |
...
- 7 RFCs `Active` (RFC 0025, RFC 0035, RFC 0036, RFC 0054, RFC 0056, RFC 0070, RFC 0071) — wire-shape MAY shift compatibly within v1.x until promotion to `Accepted`.
