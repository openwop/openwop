...
| Conformance scenario files | 417 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.77.0 | `conformance/package.json` | minor on scenario add/remove |
