...
| Conformance scenario files | 422 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.82.0 | `conformance/package.json` | minor on scenario add/remove |
