...
| Conformance scenario files | 424 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.84.0 | `conformance/package.json` | minor on scenario add/remove |
