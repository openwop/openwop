...
| Conformance scenario files | 418 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.78.0 | `conformance/package.json` | minor on scenario add/remove |
