...
| Conformance scenario files | 425 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.85.0 | `conformance/package.json` | minor on scenario add/remove |
