...
| Conformance scenario files | 359 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.33.0 | `conformance/package.json` | minor on scenario add/remove |
