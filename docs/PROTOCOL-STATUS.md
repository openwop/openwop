...
| Conformance scenario files | 496 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 2.0.0-rc.4 | `conformance/package.json` | minor on scenario add/remove |
