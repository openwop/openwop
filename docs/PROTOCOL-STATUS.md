...
| Conformance scenario files | 523 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 2.32.0 | `conformance/package.json` | minor on scenario add/remove |
...
- 3 RFCs `Active` (RFC 0111, RFC 0121, RFC 0158) — wire-shape MAY shift compatibly within v1.x until promotion to `Accepted`.
