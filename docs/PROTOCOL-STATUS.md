...
| Conformance scenario files | 412 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.72.0 | `conformance/package.json` | minor on scenario add/remove |
...
- 4 RFCs `Active` (RFC 0035, RFC 0111, RFC 0121, RFC 0136) — wire-shape MAY shift compatibly within v1.x until promotion to `Accepted`.
