...
- 9 RFCs still `Draft` (RFC 0038, RFC 0043, RFC 0050, RFC 0065, RFC 0066, RFC 0067, RFC 0068, RFC 0072, RFC 0073) — advance with schema/conformance proof or defer.
- 9 RFCs `Active` (RFC 0025, RFC 0035, RFC 0036, RFC 0042, RFC 0054, RFC 0056, RFC 0069, RFC 0075, RFC 0076) — wire-shape MAY shift compatibly within v1.x until promotion to `Accepted`.
