...
| RFCs tracked | 179 | `RFCS/[0-9][0-9][0-9][0-9]-*.md`, excluding template |
...
- 17 RFCs `Active` (RFC 0035, RFC 0111, RFC 0121, RFC 0158, RFC 0167, RFC 0168, RFC 0170, RFC 0171, RFC 0172, RFC 0173, RFC 0175, RFC 0176, RFC 0177, RFC 0179, RFC 0180, RFC 0181, RFC 0182) — wire-shape MAY shift compatibly within v1.x until promotion to `Accepted`.
