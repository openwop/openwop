...
| Conformance scenario files | 408 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.67.1 | `conformance/package.json` | minor on scenario add/remove |
