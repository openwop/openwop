...
| Conformance suite `@openwop/openwop-conformance` | 2.4.3 | `conformance/package.json` | minor on scenario add/remove |
...
- 6 RFCs `Active` (RFC 0035, RFC 0111, RFC 0121, RFC 0158, RFC 0167, RFC 0173) — wire-shape MAY shift compatibly within v1.x until promotion to `Accepted`.
