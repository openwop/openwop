...
| Conformance scenario files | 462 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.136.3 | `conformance/package.json` | minor on scenario add/remove |
