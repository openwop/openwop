...
| RFC 0117 | Front-End Plugin Packs (Sandboxed UI Extensions) | Draft |
...
- 3 RFCs still `Draft` (RFC 0038, RFC 0117, RFC 0118) — advance with schema/conformance proof or defer.
