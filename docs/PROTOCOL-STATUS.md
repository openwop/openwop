...
| Conformance scenario files | 414 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.74.0 | `conformance/package.json` | minor on scenario add/remove |
