...
| Conformance scenario files | 450 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.113.0 | `conformance/package.json` | minor on scenario add/remove |
