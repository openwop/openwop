...
| Conformance scenario files | 411 | `conformance/src/scenarios/*.test.ts` |
| RFCs tracked | 145 | `RFCS/[0-9][0-9][0-9][0-9]-*.md`, excluding template |
...
| Conformance suite `@openwop/openwop-conformance` | 1.71.0 | `conformance/package.json` | minor on scenario add/remove |
...
- 5 RFCs `Active` (RFC 0035, RFC 0111, RFC 0121, RFC 0136, RFC 0144) — wire-shape MAY shift compatibly within v1.x until promotion to `Accepted`.
