...
|---|---|---|
| RFC 0076 | Pack runtime-requirements declaration + host-provided safe-fetch | Draft |
...
| Version manifests | 86 | `registry/v1/packs/*/-/*.json` |
| Tarballs | 86 | `registry/v1/packs/*/-/*.tgz` |
| Signatures | 86 | `registry/v1/packs/*/-/*.sig` |
...
- 12 RFCs still `Draft` (RFC 0038, RFC 0042, RFC 0043, RFC 0050, RFC 0065, RFC 0066, RFC 0067, RFC 0068, RFC 0069, RFC 0072, RFC 0073, RFC 0076) — advance with schema/conformance proof or defer.
