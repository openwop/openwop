...
| RFCs tracked | 75 | `RFCS/[0-9][0-9][0-9][0-9]-*.md`, excluding template |
...
| RFC 0074 | Tenant-Scoped Manifest-Agent Inventory | Active |
...
- 8 RFCs `Active` (RFC 0025, RFC 0035, RFC 0036, RFC 0054, RFC 0056, RFC 0071, RFC 0074, RFC 0075) — wire-shape MAY shift compatibly within v1.x until promotion to `Accepted`.
