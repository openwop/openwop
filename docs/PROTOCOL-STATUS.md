...
| Conformance scenario files | 426 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.86.0 | `conformance/package.json` | minor on scenario add/remove |
