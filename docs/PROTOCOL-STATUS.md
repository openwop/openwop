...
| Conformance scenario files | 432 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.93.0 | `conformance/package.json` | minor on scenario add/remove |
