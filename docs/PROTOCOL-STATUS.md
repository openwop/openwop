...
| Conformance scenario files | 403 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.61.1 | `conformance/package.json` | minor on scenario add/remove |
