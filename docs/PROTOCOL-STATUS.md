...
|---|---:|---:|---:|---:|---:|---|
| Postgres reference | 1477 | 6 | 98 | 14 | 1595 | 92.6% total; ~99.6% of non-skipped (measured 2026-05-23 against suite v1.5.0 via pglite + OPENWOP_WEBHOOK_ALLOW_PRIVATE=true). Superseded 2026-05-25: re-run reports 2 failures - the RFC 0022 (×4) failures were a missing core.identity node (fixed), and the cost-attribution + RFC 0031 failures had already closed. The 2 remaining (webhook-signed-delivery flake + artifact-auth 404-vs-401) are pre-existing. See the 2026-05-25 update in docs/CONFORMANCE-RUNS-2026-05-23.md. |
| SQLite reference | 1490 | 7 | 84 | 14 | 1595 | 93.4% total. Superseded 2026-05-25: re-run reports 1 failure - RFC 0022 dispatch/subWorkflow mapping is now ported + passing and cost-attribution closed (#183); the lone remaining model-capability-insufficient is a pre-existing RFC 0031 gap. See the 2026-05-25 update in docs/CONFORMANCE-RUNS-2026-05-23.md. |
