...
| Conformance scenario files | 461 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.135.1 | `conformance/package.json` | minor on scenario add/remove |
