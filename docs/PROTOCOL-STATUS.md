...
| Conformance scenario files | 435 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.96.0 | `conformance/package.json` | minor on scenario add/remove |
