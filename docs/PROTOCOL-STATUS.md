...
| Conformance scenario files | 495 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 2.0.0-rc.2 | `conformance/package.json` | minor on scenario add/remove |
