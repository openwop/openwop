...
| RFC 0095 | Connection packs - a registry-distributable provider definition that resolves the RFC 0047 `provider` string | Active |
...
- 3 RFCs `Active` (RFC 0035, RFC 0043, RFC 0095) — wire-shape MAY shift compatibly within v1.x until promotion to `Accepted`.
