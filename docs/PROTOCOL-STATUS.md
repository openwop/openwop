...
| Conformance scenario files | 357 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.31.0 | `conformance/package.json` | minor on scenario add/remove |
