...
| Conformance scenario files | 437 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.104.0 | `conformance/package.json` | minor on scenario add/remove |
