...
| Conformance scenario files | 463 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.136.12 | `conformance/package.json` | minor on scenario add/remove |
...
| RFC 0162 | Durable Execution and Disaster-Recovery Qualification | Draft |
...
- 2 RFCs still `Draft` (RFC 0038, RFC 0162) — advance with schema/conformance proof or defer.
