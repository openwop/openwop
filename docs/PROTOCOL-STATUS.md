...
| Conformance scenario files | 455 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.122.0 | `conformance/package.json` | minor on scenario add/remove |
