...
|---|---:|---:|---:|---:|---:|---|
| Postgres reference | 1477 | 6 | 98 | 14 | 1595 | 92.6% total; ~99.6% of non-skipped (measured 2026-05-23 against suite v1.5.0 via pglite + OPENWOP_WEBHOOK_ALLOW_PRIVATE=true). Superseded 2026-05-25: re-run reports 0 deterministic failures (1627 passed) - the RFC 0022 (×4) failures were a missing core.identity node (fixed), the cost-attribution + RFC 0031 failures had already closed, and artifact-auth (404-vs-401) was fixed with an auth-before-existence artifact route. webhook-signed-delivery is a known full-suite timing flake (passes in isolation). See the 2026-05-25 update in docs/CONFORMANCE-RUNS-2026-05-23.md. |
| SQLite reference | 1490 | 7 | 84 | 14 | 1595 | 93.4% total. Superseded 2026-05-25: re-run reports 0 failures (1641 passed) - RFC 0022 dispatch/subWorkflow mapping is now ported + passing, cost-attribution closed (#183), and the model-capability-insufficient RFC 0031 refusal is now implemented end-to-end (first reference host to do so). See the 2026-05-25 update in docs/CONFORMANCE-RUNS-2026-05-23.md. |
