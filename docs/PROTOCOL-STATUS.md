...
| Conformance scenario files | 416 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.76.0 | `conformance/package.json` | minor on scenario add/remove |
