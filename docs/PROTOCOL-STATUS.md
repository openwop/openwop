...
| Conformance scenario files | 433 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.94.0 | `conformance/package.json` | minor on scenario add/remove |
