...
| Conformance scenario files | 454 | `conformance/src/scenarios/*.test.ts` |
...
| Conformance suite `@openwop/openwop-conformance` | 1.115.0 | `conformance/package.json` | minor on scenario add/remove |
