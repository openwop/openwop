...
outputs = {ROOT / 'api' / 'v2' / 'openapi.yaml': dump(doc), ROOT / 'api' / 'v2' / 'asyncapi.yaml': dump(adoc), ROOT / 'api' / 'seams-v2.yaml': dump(seams), ROOT / 'spec' / 'v2' / 'path-manifest.json': json.dumps(man, indent=2, ensure_ascii=False) + '\n'}
