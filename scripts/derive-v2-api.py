...
def headers_doc(doc):
    ...
    lines = ['# Headers', '', '> **Status: Stable · v2.0.9 (2026-09-10) · RFC 0171 §C.1, RFC 0172 §A.3–§A.4.** GENERATED by `scripts/derive-v2-api.py` from `api/v2/openapi.yaml`; do not edit.', '',
