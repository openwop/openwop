...
def headers_doc(doc):
    ...
    lines = ['# Headers', '', '> **Status: Stable · v2.1.4 (2026-09-12) · RFC 0171 §C.1, RFC 0172 §A.3–§A.4.** GENERATED by `scripts/derive-v2-api.py` from `api/v2/openapi.yaml`; do not edit.', '',
