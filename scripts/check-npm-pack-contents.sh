...
assert(tsPack.version === '1.1.5', `unexpected TypeScript package version: ${tsPack.version}`);
...
assert(conformancePack.version === '1.10.0', `unexpected conformance package version: ${conformancePack.version}`);
