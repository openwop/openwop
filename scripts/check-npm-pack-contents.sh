...
assert(tsPack.version === '1.0.0', `unexpected TypeScript package version: ${tsPack.version}`);
...
assert(conformancePack.version === '1.0.0', `unexpected conformance package version: ${conformancePack.version}`);
