...
assert(tsPack.version === '1.1.6', `unexpected TypeScript package version: ${tsPack.version}`);
...
assert(conformancePack.version === '1.15.0', `unexpected conformance package version: ${conformancePack.version}`);
