...
EXPECTED_CONFORMANCE_VERSION="2.0.10"
# Suite 2.0.1 (RFC 0168 §D.2): the contract package publishes beside the suite from the same tag.
EXPECTED_SPEC_ARTIFACTS_VERSION="2.0.10"
fail=0
