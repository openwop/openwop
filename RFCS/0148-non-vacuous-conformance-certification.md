...
- [ ] CHANGELOG, coverage guide, interop matrix, and migration runbook updated. (CHANGELOG landed. **Interop matrix swept 2026-08-16** — the four reference-host rows carry their bundle-v2 verdicts and the header defines the evidence vocabulary (certified / rejected / unprovable / self-declaration). Still carried: the coverage guide and the `version-negotiation.md` certification-evidence migration runbook.)
