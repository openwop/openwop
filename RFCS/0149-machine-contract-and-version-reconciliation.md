...
- [ ] Authoring lint catches wrappers, canonical typos, and shadows without closing runtime discovery. (Wrappers landed §B; shadows landed §E. Canonical typos are carried — the edit-distance-one rule needs UQ2 resolved first, since no false-positive threshold has been chosen.)
