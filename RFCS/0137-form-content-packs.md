...
| **Created**       | 2026-08-05                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Updated**       | 2026-08-05 — landed directly at `Active` (wire shape LOCKED). The 7-day comment window (`GOVERNANCE.md` §"Normative addition") was **waived** under the bootstrap-phase single-maintainer steward waiver (`CONTRIBUTING.md` §"Bootstrap-phase notes"; same mechanism as RFC 0132/0133/0134/0135), architect-reviewed by the steward. Additive/backward-compatible; no objections outstanding. Graduation to `Accepted` is gated on a reference-host witness passing the capability-gated behavioral legs non-vacuously under `OPENWOP_REQUIRE_BEHAVIOR=true`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
