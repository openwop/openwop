...
| R4 | Retrospective review destabilizes v1. | M | H | High | Risk-rank, additive/safety fixes in v1, other breaks in v2. | Compatibility Architect | Open — **Sweep 2026-08-16:** **Open** — not started. |
