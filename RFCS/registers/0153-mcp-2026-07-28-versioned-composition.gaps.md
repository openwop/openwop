...
| G2 | §C | Complete MRTR mapping is not authored. | Spec Architect | Trace MRTR lifecycle against run/interrupt/cancel/replay. | Active |
...
| G4 | §D | Authorization-aware cache validator rules are undecided. | Security Architect | Threat-model principal/tenant/scope changes. | Active |
