...
| G2 | §D | Exact run response carrying `compensationStatus` is unsettled. | Schema Architect | Trace run document/status/result schemas and choose one source. | Active |
