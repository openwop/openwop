...
| G3 | §D | First OTel GenAI mapping version is unsettled. | Observability Architect | Review stability labels; map only stable fields at Active. | Active |
...
| G5 | §D | Privacy/retention policy for hashed actor identifiers is missing. | Security Architect | Add privacy threat pass and retention guidance. | Accepted |
