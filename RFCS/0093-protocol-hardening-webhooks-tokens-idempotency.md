...
- [ ] Reference host implements delivery-time re-validation + token lifecycle and passes the new scenarios (tier-2 evidence per `GOVERNANCE.md` §Acceptance evidence tiers); `Active → Accepted` on that evidence.
