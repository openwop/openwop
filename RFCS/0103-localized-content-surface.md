...
| **Supersedes**    | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **Superseded by** | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **Amended by**    | [RFC 0206](./0206-locale-keys-accept-negotiated-bcp47.md) — Q3 / register G5: the locale-key grammar widens to the case-canonical BCP 47 subset and `resolveSection` gains the script-family step. Editorial pointer; no normative text in this RFC changes. |
