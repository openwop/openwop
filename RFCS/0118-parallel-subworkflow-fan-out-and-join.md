...
| **Created**       | 2026-06-27                                                                                                                                                                                                                                                      |
| **Updated**       | 2026-06-27 (`Draft → Active` — steward waiver of the 7-day additive comment window per `GOVERNANCE.md` lazy consensus; all five Unresolved questions resolved in-RFC because `Active` locks the wire shape) |
