...
| §E.8 replay does not re-issue | — (a host's replay of a tasked run is not reachable through the mount) | — | covered by existing `v2-run-fork-prefix` / replay rows. No new witness; stated, not claimed |
