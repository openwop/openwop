...
1. ~~Is 12/4 the correct extension budget?~~ **Resolved 2026-09-02 by RFC 0166 §C.3 (repealed): the budget was never enforced; the witness-class requirement replaces it** (closed under RFC 0174 §C.3).
...
- [x] ~~Budget and Stable evidence rules are governance-approved.~~ The numeric budget was repealed by RFC 0166 §C.3; the Stable evidence rule stands and is carried into RFC 0169 §C.2's two-axis maturity (RFC 0174 §C.3, 2026-09-03).
