...
| **Created**       | 2026-05-21                                                                                                                                                                                                                                                                                                                                            |
| **Updated**       | 2026-08-13 — Draft-stage acceptance criteria all met (`docs/working-group/` landed); **status deliberately unchanged**, see §Acceptance criteria. 2026-06-11 — **Parked** (per `RFCS/README.md` §"Parked Drafts"): deliberately idle pending the `GOVERNANCE.md` §"Path to working group" tripwires (≥3 independent-org maintainers + ≥2 non-steward conformant hosts); not abandoned. The charter is authored so ratification is mechanical the moment the tripwire fires. 2026-05-21 — filed `Draft`. |
