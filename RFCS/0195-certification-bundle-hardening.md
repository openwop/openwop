...
- [ ] A committed bundle cut on 2.35.1 or later shows `--verify` deriving the host's real opt-outs (reason: the 2.35.0 rule derived none from any real bundle; added 2026-09-22).
