...
- [ ] First non-steward host advertises 1+ universal-kind envelope schema (third-party validation gate per `RFCS/0001-rfc-process.md` §"Promotion to Accepted"). External-blocked.
