...
| **Created**       | 2026-06-23                                                                                                                                                                                                                                                                                                                              |
| **Updated**       | 2026-06-23 (`Draft → Active`: 7-day additive comment window waived per GOVERNANCE.md lazy consensus; author confirmed the four Draft resolutions (G10 closed); all Unresolved questions resolved in-RFC because `Active` locks the wire shapes — see §"Resolved questions". Normative surface (schemas, spec text, conformance, SDK) is sequenced to the `Active → Accepted` flip per the RFC 0105 precedent.) |
