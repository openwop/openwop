...
- [ ] `INTEROP-MATRIX.md`, `SECURITY.md`, `GOVERNANCE.md`, `MAINTAINERS.md`, `COMPATIBILITY.md`, `ROADMAP.md`, `docs/KNOWN-LIMITS.md`, `docs/PROTOCOL-STATUS.md`, and `CHANGELOG.md` reflect the evidence accurately. (2026-08-16 sweep: `INTEROP-MATRIX.md` (in-memory row) and `docs/KNOWN-LIMITS.md` were swept in `901a766f` (§A.9), with further `INTEROP-MATRIX.md` and `KNOWN-LIMITS.md` edits at `324d0710`, `96971233`, `74e2402c`; CHANGELOG and `docs/PROTOCOL-STATUS.md` track each landing. Still carried: `GOVERNANCE.md`, `SECURITY.md`, `COMPATIBILITY.md`, `ROADMAP.md` have no commit in the program window, and the SQLite/Python/Postgres interop rows are deliberately unswept (`docs/RFC-0147-SELF-AUDIT.md`).)
