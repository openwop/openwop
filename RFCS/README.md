...
Current tally: **Accepted 153 · Active 3 · Draft 1** (157 RFCs, excluding the `0000` template; Active = 0035 Parked, 0111 Parked, 0121 Parked; Draft = 0038 Parked).

Of the 4 non-`Accepted` RFCs, **4 are [Parked](#parked-rfcs)** on a named external tripwire and **0 await repository work**.
