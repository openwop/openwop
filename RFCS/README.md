...
Current tally: **Accepted 96 · Active 3 · Draft 3** (102 RFCs, excluding the `0000` template; Active = 0035, 0043, 0100; Draft = 0038 Parked, 0101 Parked, 0102).
...
| [0102](./0102-a2ui-agent-authored-interface-surfaces.md)             | A2UI agent-authored interface surfaces — declarative cross-trust-boundary UI as an optional `ui.a2ui-surface` envelope kind (extends RFC 0055; actions confined to interrupt-resume/exchange)                                                | `Draft`              |
