...
Current tally: **Accepted 153 · Active 3 · Draft 2** (158 RFCs, excluding the `0000` template; Active = 0035 Parked, 0111 Parked, 0121 Parked; Draft = 0038 Parked, 0162).
...
| [0162](./0162-durable-execution-and-disaster-recovery-qualification.md) | Durable Execution and Disaster-Recovery Qualification | `Draft` |
## See also
