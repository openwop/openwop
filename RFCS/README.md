...
Current tally: **Accepted 158 · Active 7 · Draft 1** (166 RFCs, excluding the `0000` template; Active = 0035 Parked, 0111 Parked, 0121 Parked, 0158, 0167, 0169, 0172; Draft = 0038 Parked).

Of the 8 non-`Accepted` RFCs, **4 are [Parked](#parked-rfcs)** on a named external tripwire and **4 await repository work**.
