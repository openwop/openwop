...
| [0102](./0102-a2ui-agent-authored-interface-surfaces.md)             | A2UI agent-authored interface surfaces — declarative cross-trust-boundary UI as an optional `ui.a2ui-surface` envelope kind (extends RFC 0055; actions confined to interrupt-resume/exchange)                                                | `Active`             |
