...
Current tally: **Accepted 156 · Active 6 · Draft 1** (163 RFCs, excluding the `0000` template; Active = 0035 Parked, 0111 Parked, 0121 Parked, 0158, 0165, 0166; Draft = 0038 Parked).

Of the 7 non-`Accepted` RFCs, **4 are [Parked](#parked-rfcs)** on a named external tripwire and **3 await repository work**.
