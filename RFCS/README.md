...
Current tally: **Accepted 89 · Active 4 · Draft 7** (100 RFCs, excluding the `0000` template; the Draft count includes the RFC 0038 working-group charter, which is Parked). <!-- Hand-maintained; the per-row Status column is authoritative if this prose tally drifts. -->
