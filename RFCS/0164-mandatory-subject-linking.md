...
- [ ] Reference host (openwop-app) narrows its advertisement when realms are misaligned and witnesses that both profiles are never advertised without the derived flag — gates `Active → Accepted`; tracked on crosstalk `0164`.
