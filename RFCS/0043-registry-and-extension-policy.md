...
| **Created**       | 2026-05-22                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Updated**       | 2026-07-07 — `Active → Accepted`: the 7-day public comment window was **waived** under the bootstrap-phase steward waiver (no unresolved objections on the additive policy; same mechanism as RFC 0121). WG ratification remains a future-action gate per RFC 0038 (non-blocking, WG-revisitable) — never a landing blocker. Policy has been live + cited as authoritative from normative spec since 2026-06-11; the five §Unresolved questions stand at their proposed bootstrap defaults (WG-revisitable). No wire-shape or schema change. 2026-06-11 — `Draft → Active`: policy is live ([`docs/governance/registry-policy.md`](../docs/governance/registry-policy.md)) and cited as authoritative from normative spec (`host-extensions.md` §"Canonical prefixes", `registry-operations.md` policy layer); full ratification deferred to WG formation per RFC 0038. 2026-05-22 — filed `Draft`. |
...
> **Resolution note (2026-07-07, bootstrap steward).** On graduation to `Accepted`, each question below stands at its **proposed bootstrap default** (Q1: registry's choice of well-known path; Q2: 72-hour yank window; Q3: no trademark; Q4: 14-day patent-disclosure SLA; Q5: `openwop.*` reserved, `host.*` left as host-extensions territory). These are additive-policy refinements, not wire-shape or graduation blockers — the acceptance gate is the (now-waived) comment window, not these — and each is **WG-revisitable** the moment the `GOVERNANCE.md` tripwire fires (RFC 0038).
...
- [x] 7-day public comment window **waived** under the bootstrap-phase steward waiver (2026-07-07; same waiver mechanism as RFC 0121 §Status history). No unresolved objections on the additive policy at waiver time.
- [x] Working group ratification remains a **future-action gate, not a blocker** (gated on the `GOVERNANCE.md` tripwire per RFC 0038 — WG-revisitable, mechanical at WG formation). With the comment window waived and WG ratification explicitly non-blocking, this RFC graduates `Active → Accepted` (2026-07-07). The five §Unresolved policy questions carry their proposed bootstrap defaults (adopted) and are WG-revisitable — none is a graduation blocker.
