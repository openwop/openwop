...
- [ ] Reference host (openwop-app) advertises `subjectLinkKey` and enforces the §B same-IdP check — gates `Active → Accepted`; tracked on the crosstalk `0163` board as T8/T9.
